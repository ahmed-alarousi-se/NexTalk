    ...
    <section className="hidden md:flex h-full flex-1 items-center justify-center bg-chat-bg">
      <div className="text-center max-w-xs px-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          End-to-end fast, beautifully quiet. Select a conversation on the left, or start a new one.
        </p>
        <p className="mt-5 text-[11px] text-muted-foreground/60">Realtime · Secure · Cross-device</p>
      </div>
    </section>
  );
}
